...
const ALUMNI_DATA = [
  {
    ...
    quote: "SCR provided the technical foundation and deal-flow exposure that directly translated to success in my summer internship and full-time role."
  },
  {
    id: 2,
    name: "Elena Rostova",
    scrRole: "Quantitative Researcher",
    department: "Quantitative Finance",
    classYear: "2024",
    currentRole: "Quantitative Trader",
    company: "Citadel",
    location: "London, UK",
    linkedin: "https://linkedin.com",
    quote: "The rigor of building backtesting engines at SCR gave me a massive head start in the highly competitive quant recruiting process."
  },
  {
    id: 3,
    name: "James Chen",
    scrRole: "Senior Equity Analyst",
    department: "Equity Research",
    classYear: "2022",
    currentRole: "Equity Research Associate",
    company: "Morgan Stanley",
    location: "New York, USA",
    linkedin: "https://linkedin.com",
    quote: "Learning how to dissect a 10-K and build a three-statement model from scratch at SCR was invaluable."
  },
  {
    id: 4,
    name: "Sarah Jenkins",
    scrRole: "Lead Economist",
    department: "Economic Research",
    classYear: "2023",
    currentRole: "Macroeconomic Strategist",
    company: "Bank of England",
    location: "London, UK",
    linkedin: "https://linkedin.com",
    quote: "Presenting thematic macro trends to the SCR board honed my ability to communicate complex economic shifts clearly and effectively."
  },
  {
    id: 5,
    name: "David Osei",
    ...
    department: "Mergers & Acquisitions",
    classYear: "2024",
    currentRole: "Private Equity Analyst",
    company: "Blackstone",
    location: "London, UK",
    linkedin: "https://linkedin.com",
    quote: "The LBO modeling workshops and pitch sessions prepared me for the rigorous technical interviews in buy-side finance."
  },
  {
    id: 6,
    name: "Maria Gonzalez",
    ...
    department: "Equity Research",
    classYear: "2022",
    currentRole: "Asset Management Analyst",
    company: "Goldman Sachs",
    location: "Frankfurt, Germany",
    linkedin: "https://linkedin.com",
    quote: "Leading SCR taught me as much about management and strategy as it did about financial markets. An unforgettable experience."
  }
];
