...
export default function Footer() {
  return (
    <footer className="bg-[#001438] text-white">
      {/* top section */}
      <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-4 gap-12">
        {/* Brand */}
        <div className="md:col-span-2">
          <div className="flex items-center gap-2.5 mb-4">
            <div className="w-9 h-9 bg-[#B9975B] rounded-lg flex items-center justify-center">
              <TrendingUp size={18} className="text-[#00205B]" strokeWidth={2.5} />
            </div>
            <div>
              <p className="font-bold text-base tracking-wide">Surrey Capital Research</p>
              <p className="text-[#B9975B] text-[10px] font-semibold tracking-widest uppercase">
          ...
          <div className="flex gap-4 mt-6">
            <a
              ...
              className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center
                         hover:bg-[#B9975B] hover:text-[#00205B] text-white/70 transition-all duration-200"
            >
        ...
        {Object.entries(FOOTER_LINKS).map(([title, links]) => (
          <div key={title}>
            <h4 className="text-[#B9975B] font-semibold text-xs tracking-widest uppercase mb-4">
              {title}
            </h4>
